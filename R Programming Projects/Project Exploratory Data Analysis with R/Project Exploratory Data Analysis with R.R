...
cat("\014")                                     ##
                                                ##
#######################################################################
setwd("C:/Users/91841/Desktop/BIG_DATA/Data_analytics/Assignment _1")##
getwd()                                                              ##  
#######################################################################
...
load("C:/Users/91841/Desktop/BIG_DATA/Data_analytics/Assignment _1/PROG8430_Assign_Explore-21F.RData")
print(PROG8430_Assign_Explore)
class(PROG8430_Assign_Explore)

###################################################
#Q.1-1-a
###########################################################################

T_income_marital_PP<-aggregate(PROG8430_Assign_Explore$income,
by=list(m_sts=PROG8430_Assign_Explore$m.status),FUN=sum)
...
nation_age_mean_PP<-tapply(PROG8430_Assign_Explore$age, PROG8430_Assign_Explore$nation, mean)
...
Asia_resp<-as.data.frame(PROG8430_Assign_Explore[PROG8430_Assign_Explore$nation=='Asia'
...
Poli_aware<-aggregate(PROG8430_Assign_Explore$score,
...
tapply(PROG8430_Assign_Explore$score,PROG8430_Assign_Explore$gender,mean)
##############################################################
#Q-1-3-b
##############################################################
...
quantile(PROG8430_Assign_Explore$time1,c(0.34,0.63))
...
piedata=data.frame(table(PROG8430_Assign_Explore$political))
...
summ_table_PP=table(PROG8430_Assign_Explore$nation,PROG8430_Assign_Explore$group)
...
pol_data_PP<-tapply(PROG8430_Assign_Explore$scr,PROG8430_Assign_Explore$nation,mean)
...
bar_max_min_pp<-aggregate.data.frame(PROG8430_Assign_Explore$scr, by=list(
nation=PROG8430_Assign_Explore$nation),FUN=mean)
...
Hist_pp=hist(PROG8430_Assign_Explore$food*100,breaks=5, main="Percentage of household income going to food",
...
box_pp<-boxplot(income~m.status,data =PROG8430_Assign_Explore, main="Distribution of 
...
hist(PROG8430_Assign_Explore$income, main="histogram for income."
,col = "red", xlab ="Total income")
##############################################################
#Q-2-6-b
##############################################################
hist(PROG8430_Assign_Explore$scr, main="histogram for Standardized Score Test."
...
plot(scr ~ income, data=PROG8430_Assign_Explore, main="scr by Income")
...
#Q-2-6-e
##############################################################
cor(PROG8430_Assign_Explore$scr,PROG8430_Assign_Explore$income)
...
#Q-3-2-a
##############################################################
var.test(score ~ group, data = PROG8430_Assign_Explore)

Ttest_PP<-t.test(score ~ group, data = PROG8430_Assign_Explore, var.equal = TRUE)
Ttest_PP
...
#Q-3-3-a
##############################################################
ANOVA_SN_PP=aov(score ~ nation, data = PROG8430_Assign_Explore)
ANOVA_SN_PP
summary(ANOVA_SN_PP)
...
#Q-3-3-b
##############################################################
ANOVA_PP_PP=aov(Pol ~ political, data = PROG8430_Assign_Explore)
ANOVA_PP_PP
summary(ANOVA_PP_PP)
